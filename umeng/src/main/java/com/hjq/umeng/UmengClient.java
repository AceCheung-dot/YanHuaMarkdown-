...
import static com.taobao.accs.a.a.TAG;
...
public final class UmengClient {
     ...
     * 初始化友盟相关 SDK
     */
    public static String success_token;
    public static String init(final Application application) {
        ...
        try {
            ...
            UMConfigure.init(application, "5d953a873fc1957a8b00032d","Umeng",UMConfigure.DEVICE_TYPE_PHONE,"c271550f263ad86364a2d5fbcd2f49cd");
            // 初始化各个平台的 Key
...
//注册推送服务，每次调用register方法都会回调该接口
            mPushAgent.register(new IUmengRegisterCallback() {
                ...
                public void onSuccess(String deviceToken) {
                    ...
                    success_token=deviceToken;
                    Log.i(TAG, "注册成功：deviceToken：-------->  " + deviceToken);
                    PushAgent.getInstance(application.getApplicationContext()).onAppStart();
